...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("FTDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.4.107"];
pub const RS_PUB_KEY: &str = "g6+xiYLMfNg7oJy9VJ006FIvNthXGOp9jyoCGUmoGIA=";
